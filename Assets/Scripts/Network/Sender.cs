...
//    {
//        Debug.LogError("Shouldn get called updt vbuff");
...
//        //IPEndPoint ip = Listener.Instance.listener.LocalEndPoint as IPEndPoint;
//        //BufferStruct.ListenerSocketInfo.portNum = ip.Port;
...
//            if (BufferStruct.SyncClock.waitForHost!=0)
//            {
//                BufferStruct.SyncClock.waitForHost = 0;
//            }
...
//    {
//        ++_waitedFrames;
//        if (!sender.Connected || ClientData.IsPaused)
//        {
//            return;
//        }
...
//    //public bool TryConnectToPort(int portNum)
//    //{
//    //    try
//    //    {
//    //        IPAddress hostIP;
...
//    //        Sender.Instance.sender.ConnectAsync(ip).Wait();
//    //        Debug.Log("Trying to connect to listener");
//    //        ClientData.IsClientInitiator = !Receiver.Socket.Connected;
//    //        return true;
//    //    }
//    //    catch (Exception e)
//    //    {
...
//    //        return Sender.Instance.sender.Connected;
//    //    }
